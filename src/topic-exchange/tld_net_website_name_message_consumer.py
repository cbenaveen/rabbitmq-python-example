...
from constant import DEFAULT_RABBITMQ_URL, \
    ...
    NET_TLD_WEBSITE_NAME_QUEUE, \
    NET_TLD_WEBSITE_NAME_ROUTINGKEY
...
class RabbitMQWebsiteNameMessageConsumer:
    def __init__(self):
        ...
        try:
            ...
            channel.queue_declare(queue=NET_TLD_WEBSITE_NAME_QUEUE)

            # Bind the queue with exchange using the routing key
            channel.queue_bind(queue=NET_TLD_WEBSITE_NAME_QUEUE,
                               exchange=WEBSITE_TLD_EXCHANGE_NAME,
                               routing_key=NET_TLD_WEBSITE_NAME_ROUTINGKEY)
    ...
    def consume(self):
        ...
        channel.basic_consume(self.process_message,
                              queue=NET_TLD_WEBSITE_NAME_QUEUE)
