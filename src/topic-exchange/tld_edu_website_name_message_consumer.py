...
from constant import DEFAULT_RABBITMQ_URL, \
    ...
    EDU_TLD_WEBSITE_NAME_QUEUE, \
    EDU_TLD_WEBSITE_NAME_ROUTINGKEY
...
class RabbitMQWebsiteNameMessageConsumer:
    def __init__(self):
        ...
        try:
            ...
            channel.queue_declare(queue=EDU_TLD_WEBSITE_NAME_QUEUE)

            # Bind the queue with exchange using the routing key
            channel.queue_bind(queue=EDU_TLD_WEBSITE_NAME_QUEUE,
                               exchange=WEBSITE_TLD_EXCHANGE_NAME,
                               routing_key=EDU_TLD_WEBSITE_NAME_ROUTINGKEY)
    ...
    def consume(self):
        ...
        channel.basic_consume(self.process_message,
                              queue=EDU_TLD_WEBSITE_NAME_QUEUE)
