...
from constant import DEFAULT_RABBITMQ_URL, \
    ...
    COM_TLD_WEBSITE_NAME_QUEUE, \
    COM_TLD_WEBSITE_NAME_ROUTINGKEY
...
class RabbitMQWebsiteNameMessageConsumer:
    def __init__(self):
        ...
        try:
            ...
            channel.queue_declare(queue=COM_TLD_WEBSITE_NAME_QUEUE)

            # Bind the queue with exchange using the routing key
            channel.queue_bind(queue=COM_TLD_WEBSITE_NAME_QUEUE,
                               exchange=WEBSITE_TLD_EXCHANGE_NAME,
                               routing_key=COM_TLD_WEBSITE_NAME_ROUTINGKEY)
    ...
    def consume(self):
        ...
        channel.basic_consume(self.process_message,
                              queue=COM_TLD_WEBSITE_NAME_QUEUE)
